...
const TypingBox = () => {
  ...
  const handleKeyDown = (e) => {
    ...
    else allChildrenSpans[currCharIndex + 1].className = "char current";
  ...
  useEffect(() => {resetTest()}, [testTime, testMode, testWords]);
  ...
  return (
    <div>
      {testOver ? (
        ...
        <>
          <Menu countDown={countDown} currWordIndex={currWordIndex} />
